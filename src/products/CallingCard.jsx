        ...
        <div className="w-full max-w-[95rem] mx-auto bg-white/90 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-100 p-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
            ...
            <div className="flex flex-col items-center">
              <h1 className="text-3xl font-bold text-gray-800 mb-6">Calling Card</h1>
              <p className="text-sm text-gray-600 mb-6 leading-relaxed text-center max-w-xl">
                Our high-quality calling card prints are available with a variety
                of paper types and finishes. Make a lasting impression with
                professional, full-color cards on premium paper stock.
              </p>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-semibold text-gray-700">
                    Number of Copies <span className="text-xs text-gray-500">(min. 100)</span>
                  </label>
                  <input
                    type="number"
                    min="100"
