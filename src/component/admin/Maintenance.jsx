    ...
    const handleSave = async () => {
      try {
        ...
        const endpoint = isMaintenance
          ? `${API_URL}/maintenance/on`
          : `${API_URL}/maintenance/off`;
        ...
        // Notify wrapper immediately
        window.dispatchEvent(new Event("maintenance-updated"));

        fetchStatus();
      } catch (err) {
        showToast("Error saving maintenance");
      }
    };
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {attributes.map((attr) => (
                  ...
                  >
                    ...
                    <p className="font-semibold text-black-700 sticky top-0 bg-gray-100 p-2 border-b border-gray-300 z-10">
                      {attr.attribute_name}
                    </p>
