...
export default function Toolbar() {
  const { addText, addShape, addImage, undo, redo, state } = useEditor();
    ...
    <div className="flex flex-wrap items-center justify-between w-full px-4 sm:px-6 py-3 select-none border-b border-blue-400/40 shadow-lg bg-gradient-to-r from-blue-700 via-blue-600 to-indigo-600 text-white backdrop-blur-xl relative z-50 rounded-4xl">
      ...
      <div className="flex flex-wrap items-center gap-3 sm:gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2 border-l border-white/30 pl-3 sm:pl-4">
          <button
            onClick={() => addText()}
            className="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-blue-500/20 border border-blue-300/30 hover:bg-blue-400/40 hover:shadow-[0_0_8px_rgba(96,165,250,0.8)] transition text-sm sm:text-base"
            title="Add Text"
          >
        ...
        <div className="flex flex-wrap items-center gap-2 border-l border-white/30 pl-3 sm:pl-4">
          ...
          <button
            ...
            className="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-yellow-500 border border-blue-300/30 hover:bg-yellow-400 hover:shadow-[0_0_8px_rgba(96,165,250,0.8)] transition text-sm sm:text-base"
          >
      ...
      <div className="relative mt-2 sm:mt-0">
        <button
          ...
          className="flex items-center gap-1 bg-white text-blue-700 font-semibold px-4 py-1.5 rounded-lg shadow-md hover:bg-blue-50 hover:shadow-[0_0_8px_rgba(96,165,250,0.6)] transition text-sm sm:text-base"
        >
