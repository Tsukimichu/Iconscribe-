        ...
        <div className="w-full max-w-[95rem] mx-auto bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-100 p-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
            ...
            <div className="flex flex-col items-center">
              <h1 className="text-3xl font-bold text-gray-800 mb-6">Flyers</h1>
              <p className="text-base text-gray-600 mb-6 leading-relaxed text-center max-w-xl">
                ...
                with high-quality flyers. Multiple sizes and finishes available —
                perfect for grabbing attention. Same-day printing available for
                urgent needs.
              </p>
            ...
            <form className="space-y-8">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-semibold text-gray-700">
                    Number of Copies <span className="text-xs text-gray-500">(min. 1,000)</span>
                  </label>
                  <input
                    type="number"
                    min={1000}
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="flex flex-col gap-3">
                  <label className="flex items-center gap-2 text-sm font-semibold text-gray-700">
                    <input type="checkbox" className="w-4 h-4 accent-blue-600" /> Colored
                  </label>
                  <label className="flex items-center gap-2 text-sm font-semibold text-gray-700">
                    <input type="checkbox" className="w-4 h-4 accent-blue-600" /> Lamination
                  </label>
                  <label className="flex items-center gap-2 text-sm font-semibold text-gray-700">
                    <input type="checkbox" className="w-4 h-4 accent-blue-600" /> Back-to-Back Print
                  </label>
                </div>
              </div>
