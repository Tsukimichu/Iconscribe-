      ...
      <div className="w-full min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center">
        <div className="w-full max-w-[120rem] p-2 sm:p-2">
          ...
          <div className="flex items-center gap-3 mb-10">
            ...
            <h2 className="text-4xl font-bold text-black ml-200">Service Request</h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex flex-col items-center">
              ...
              {/* Extra paragraph when logged out */}
              {!isLoggedIn && (
                <div className="flex flex-col items-center gap-4 mb-6 max-w-xl">
                  <p className="text-base text-gray-700 leading-relaxed text-center">
                    You need to log in to place an order. Please log in to fill
                    out your details and upload required documents.
                  </p>
                </div>
              )}
            ...
            <form onSubmit={handlePlaceOrder} className="space-y-6 text-black">
              ...
              <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
                ...
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 rounded-2xl shadow-md p-6 w-64 text-right">
                  ...
                  <p className="text-3xl font-extrabold text-black">₱1,100.00</p>
                </div>
              </div>
