...
function Signup() {
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-white/20 backdrop-blur-2xl p-8 rounded-3xl shadow-2xl max-w-md w-full text-center border border-white/30">
        ...
        <AnimatePresence mode="wait">
          {success ? (
            ...
            >
              <CheckCircle className="mx-auto text-green-400 drop-shadow-md" size={56} />
            ...
            >
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-white/70 border border-gray-300 text-gray-900 placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-yellow-400"
                  required
                />
                <input
                  type="tel"
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-white/70 border border-gray-300 text-gray-900 placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-yellow-400 pr-12"
                    required
                  />
                  <button
                    type="button"
